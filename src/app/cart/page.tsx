          ...
          >
            ...
            {isMounted && items.length === 0 ? (
              <div className="flex h-full items-center justify-center space-y-1">
                ...
                >
                  <Image
                    src="/hippo-empy-cart.png"
                    fill
                    loading="eager"
                    alt="empty shopping cart"
                  />
                </div>
                <h3 className="font-smibold text-2xl">Your Cart Is Empty</h3>
                ...
                items.map(({ product }) => {
                  ...
                  return (
                    <li key={product.id} className="flex py-6 sm:py-10">
                      ...
                      <div className="ml04 flex flex-1 flex-col justify-between sm:ml-6">
                        <div className="relative pr-9 sm:grid-cols-2 sm:gap-x-6 sm:pr-0">
                          <div>
                            ...
                            <div className="mt-1 flex tex-sm">
